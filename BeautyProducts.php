<?php
include "./index_Cus.php"; // Assuming this includes the customer side view
...
try {
    ...
    // Modified SQL query to retrieve data based on the structure of the 'products' table
    $select_sql = "
        ...
        WHERE c.name = 'Beauty Products'  -- Filter for Beauty Products category
    ";
