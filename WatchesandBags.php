...
try {
    ...
    // Modified SQL to include the 'image' column from the updated products table
    $select_sql = "
        SELECT p.id AS product_id, p.code, p.name, p.description, p.quantity, p.Price, p.availability, p.category_id, 
               c.name AS category_name, 
               p.image AS product_image  -- Updated to use 'image' from products table
        FROM products p
        LEFT JOIN categories c ON p.category_id = c.id
        WHERE c.name = 'Watches and Bags'  -- Filter for Watches and Bags category
    ";
...
<section id="content">
    <main>
        ...
        <div class="head-title">
            <div class="left">
                <h1>Watches and Bags Products</h1>
                <ul class="breadcrumb">
